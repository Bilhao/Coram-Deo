...
void main() {
  group('Selecionados.getRouteForNorm tests', () {
    test('Mapeia normas com oração correspondente exata', () {
      expect(
        Selecionados.getRouteForNorm('Oferecimento de Obras'),
        '/oferecimento-de-obras',
      );
      expect(
        Selecionados.getRouteForNorm('Ângelus/Regina Cæli'),
        '/angelus-regina-caeli',
      );
      expect(
        Selecionados.getRouteForNorm('Angelus/Regina Cæli'),
        '/angelus-regina-caeli',
      );
      expect(Selecionados.getRouteForNorm('Terço'), '/santo-rosario');
      expect(Selecionados.getRouteForNorm('Santo Rosário'), '/santo-rosario');
      expect(
        Selecionados.getRouteForNorm('Contemplar o Santo Rosário'),
        '/santo-rosario-livro',
      );
      expect(
        Selecionados.getRouteForNorm('Visita ao Santíssimo'),
        '/visita-ao-santissimo',
      );
      expect(Selecionados.getRouteForNorm('Preces'), '/preces');
      expect(
        Selecionados.getRouteForNorm('Exame de Consciência'),
        '/exame-de-consciencia-oracao',
      );
    ...
    test(
      'Retorna null para normas genéricas sem oração exata correspondente',
      () {
        ...
        expect(
          Selecionados.getRouteForNorm('Leitura do Novo Testamento'),
          isNull,
        );
        expect(
          Selecionados.getRouteForNorm('Três Ave-Marias para a pureza'),
          isNull,
        );
      },
    );
