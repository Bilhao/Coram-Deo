...
void main() {
  group('Liturgia Diaria data integrity', () {
    test(
      'Sanitizes attached verse numbers from raw API into clean liturgical proclamation text',
      () {
        ...
        ld.data = {
          ...
          'primeiraLeitura': {
            ...
            'texto':
                '16pregar o Evangelho não é motivo de glória. 17Se eu exercesse...',
          },
          'salmo': {
            'referencia': 'Sl 83 (84)',
          ...
          'evangelho': {
            ...
            'texto':
                'Naquele tempo, 39Jesus contou uma parábola: “Pode um cego guiar outro cego? 40Um discípulo não é maior...',
          },
        };

        // Readings should be clean continuous liturgical prose without attached digits
        expect(
          ld.getPrimeiraLeituraTexto(),
          equals(
            'pregar o Evangelho não é motivo de glória. Se eu exercesse...',
          ),
        );
        expect(ld.getPrimeiraLeituraReferencia(), equals('1Cor 9, 16-19'));
        expect(
          ld.getSalmoTexto(),
          equals('– Minha alma desmaia de saudades...'),
        );
        expect(
          ld.getEvangelhoTexto(),
          equals(
            'Naquele tempo, Jesus contou uma parábola: “Pode um cego guiar outro cego? Um discípulo não é maior...',
          ),
        );
  ...
  group('Book title mapping integrity', () {
    ...
    test('Maps all book internal keys to user-facing book titles', () {
      ...
      expect(
        formatTitle('santo_rosario_livro', 'Título Personalizado'),
        equals('Título Personalizado'),
      );
    });
  });
}
