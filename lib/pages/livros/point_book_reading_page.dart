        ...
        builder: (context, provider, child) => Scaffold(
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                  onPressed: increaseFontSize, icon: const Icon(Icons.add)),
            ],
          ),
          body: SafeArea(
            child: SelectionArea(
                  ...
                  : Column(
                      children: [
                          ...
                          child: SingleChildScrollView(
                            ...
                            children: [
                              provider.contentIds.length != 1
                                  ? ExpansionTile(
                                      title: const Text("Pontos do capítulo",
                              ...
                              for (int i = 0;
                                ...
                                Padding(
                                  ...
                                  child: Text.rich(
                                      key: GlobalObjectKey(
                                          provider.contentIds[i]),
                                      TextSpan(children: [
                                        TextSpan(
                                            text: provider.contentIds[i] == 0
                                                ? ""
                                                : "${provider.contentIds[i]}\n",
                                            style: TextStyle(
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              onPressed: provider.currentChapterId ==
                                      provider.fistChapterId
                                  ? null
                                  : () {
                                      provider.changeChapter(
                                          provider.currentChapterId -
                                              provider.fistChapterId -
                                              1);
                                    },
