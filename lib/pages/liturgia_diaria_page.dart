                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              ...
                              const Divider(
                                  height: 15, color: Colors.transparent),
                              Text(provider.primeiraLeituraTitulo,
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 3),
                                  textAlign: TextAlign.left),
                              const Divider(
                                  height: 15, color: Colors.transparent),
                              Text(provider.primeiraLeituraText,
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 2)),
                              const Divider(
                                  height: 25, color: Colors.transparent),
                              Text("Salmo (${provider.salmoReferencia})",
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 6,
                                      fontWeight: FontWeight.bold),
                                  textAlign: TextAlign.center),
                              ...
                              Text("— ${provider.salmoRefrao}",
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 2)),
                              Text("R — ${provider.salmoRefrao}",
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 2,
                                      fontWeight: FontWeight.bold)),
                              const Divider(
                                  height: 15, color: Colors.transparent),
                              Text(provider.salmoText,
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 2)),
                              const Divider(
                                  height: 25, color: Colors.transparent),
                              if (provider.segundaLeituraTitulo != "")
                                Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold),
                                    textAlign: TextAlign.center),
                              if (provider.segundaLeituraReferencia != "")
                                const Divider(
                                    height: 15, color: Colors.transparent),
                              if (provider.segundaLeituraTitulo != "")
                                Text(provider.segundaLeituraTitulo,
                                    style: TextStyle(
                                        fontSize: provider.fontsize + 3),
                                    textAlign: TextAlign.left),
                              if (provider.segundaLeituraText != "")
                                const Divider(
                                    height: 15, color: Colors.transparent),
                              if (provider.segundaLeituraText != "")
                                Text(provider.segundaLeituraText,
                                    style: TextStyle(
                                        fontSize: provider.fontsize + 2)),
                              if (provider.segundaLeituraText != "")
                                const Divider(
                              ...
                              const Divider(
                                  height: 15, color: Colors.transparent),
                              Text(provider.evangelhoTitle,
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 3),
                                  textAlign: TextAlign.left),
                              const Divider(
                                  height: 15, color: Colors.transparent),
                              Text(provider.evangelhoText,
                                  style: TextStyle(
                                      fontSize: provider.fontsize + 2)),
                              const Divider(
                                  height: 15, color: Colors.transparent),
                              Text("Fonte: https://liturgiadiaria.site/",
                                  style: TextStyle(
                                      fontSize: provider.fontsize - 2,
