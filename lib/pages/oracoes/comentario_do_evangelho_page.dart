...
class ComentarioDoEvangelhoPage extends StatefulWidget {
  ...
  @override
  State<ComentarioDoEvangelhoPage> createState() =>
      _ComentarioDoEvangelhoPageState();
}
...
class _ComentarioDoEvangelhoPageState extends State<ComentarioDoEvangelhoPage> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<ComentarioDoEvangelhoProvider>(
                            ...
                            children: [
                              ...
                              Text.rich(TextSpan(children: [
                                for (String text in provider.evangelhoText)
                                  TextSpan(
                                      text: "$text "
                                          .replaceFirst(provider.evangelho, ""),
                                      style: TextStyle(
                              ...
                              Align(
                                  alignment: Alignment.center,
                                  child: Text(provider.comentarios,
                              ...
                              for (String text in provider.comentariosText)
                                Text("$text\n",
                                    style:
                                        TextStyle(fontSize: provider.fontSize)),
                              const Divider(
                                  height: 15, color: Colors.transparent),
                              Text("Fonte: https://opusdei.org/pt-br/gospel/",
                                  style: TextStyle(
