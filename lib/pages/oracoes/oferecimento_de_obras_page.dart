...
class OferecimentoDeObrasPage extends StatefulWidget {
  ...
  @override
  State<OferecimentoDeObrasPage> createState() =>
      _OferecimentoDeObrasPageState();
}
            ...
            child: SingleChildScrollView(
              child: Column(
                  ...
                  children: [
                    ...
                    Text("Eu Vos adoro, meu Deus, e Vos amo de todo o coração.",
                        style: TextStyle(fontSize: fontSize)),
                    Text(
                        "\nDou-Vos graças por me terdes criado, feito cristão pelo santo Batismo e me conservado nesta noite.",
                        style: TextStyle(fontSize: fontSize)),
                    Text(
                    ...
                    Text("\nPreservai-me do pecado e de todo o mal.",
                        style: TextStyle(fontSize: fontSize)),
                    Text(
                        "\nA Vossa graça esteja sempre comigo e com todos os que me são queridos.",
                        style: TextStyle(fontSize: fontSize)),
                    Align(
