...
class AmigosDeDeusReadingPage extends StatefulWidget {
  final String bookName;

  const AmigosDeDeusReadingPage({super.key, required this.bookName});

  @override
  State<AmigosDeDeusReadingPage> createState() => _AmigosDeDeusReadingPageState();
}

class _AmigosDeDeusReadingPageState extends State<AmigosDeDeusReadingPage> {
  @override
