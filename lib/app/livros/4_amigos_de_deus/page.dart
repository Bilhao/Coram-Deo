...
class _AmigosDeDeusPageState extends State<AmigosDeDeusPage> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      initialIndex: 0,
      child: Scaffold(
        appBar: AppBar(title: const Text("Amigos de Deus", maxLines: 2, style: TextStyle(fontSize: 20))),
        ...
        body: TabBarView(
          children: [
            const Indice(),
            const ThematicIndexPage(bookName: "amigos_de_deus"),
            const Sobre(),
          ],
        ),
        floatingActionButton: _selectedIndex == 0
            ? FloatingActionButton.extended(
                onPressed: () async {
                  Navigator.pushNamed(context, '/book-reading', arguments: {"bookName": "amigos_de_deus"});
                },
