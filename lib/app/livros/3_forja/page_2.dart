...
class ForjaReadingPage extends StatefulWidget {
  final String bookName;

  const ForjaReadingPage({super.key, required this.bookName});

  @override
  State<ForjaReadingPage> createState() => _ForjaReadingPageState();
}

class _ForjaReadingPageState extends State<ForjaReadingPage> {
  @override
