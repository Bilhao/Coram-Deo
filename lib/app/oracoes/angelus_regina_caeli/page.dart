                  ...
                  child: Column(
                    ...
                    children: selected == "angelus"
                      ...
                      Text.rich(TextSpan(children: [
                        ...
                        TextSpan(text: language == "pt" ? "O Anjo do Senhor anunciou a Maria." : "Angelus Dómini nuntiávit Maríæ.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n℟.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "E Ela concebeu pelo poder do Espírito Santo." : "Et concépit de Spíritu Sancto.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(
                            text: language == "pt"
                        ...
                        TextSpan(text: "\n\n℣.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Eis aqui a escrava do Senhor." : "Ecce ancílla Dómini.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n℟.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Faça-se em Mim segundo a vossa palavra." : "Fiat mihi secúndum verbum tuum.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(
                            text: language == "pt"
                                ? "\n\nAve, Maria, cheia de graça, o Senhor é convosco. Bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amem."
                                : "\n\nAve María, gratia plena, Dominus tecum, benedicta tu in muliéribus, et benedictus fructus ventris tui Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.",
                            style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n\n℣.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "E o Verbo Divino se fez carne." : "Et Verbum caro factum est.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n℟.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "E habitou entre nós." : "Et habitávit in nobis.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(
                            text: language == "pt"
                                ? "\n\nAve, Maria, cheia de graça, o Senhor é convosco. Bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amem."
                                : "\n\nAve María, gratia plena, Dominus tecum, benedicta tu in muliéribus, et benedictus fructus ventris tui Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.",
                            style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n\n℣.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Rogai por nós, Santa Mãe de Deus." : "Ora pro nobis, sancta Dei Génetríx.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n℟.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Para que sejamos dignos das promessas de Cristo." : "Ut digni efficiámur promissionibus Christi.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: language == "pt" ? "\n\nOremos:" : "\n\nOremus:", style: TextStyle(fontSize: fs.fontSize + 2, fontWeight: FontWeight.bold)),
                        TextSpan(
                            text: language == "pt"
                      ...
                      Text.rich(TextSpan(children: [
                        TextSpan(text: "℣.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Rainha do céu, alegrai-Vos, aleluia." : "Regína Cæli, lætáre, alleluia.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n℟.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Porque quem merecestes trazer em vosso seio, aleluia." : "Quia quem meruísti portáre, alleluia", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n\n℣.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Ressuscitou como disse, aleluia." : "Resurréxit, sicut dixit, alleluia.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n℟.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Rogai a Deus por nós, aleluia." : "Ora pro nóbis Deum, alleluia.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n\n℣.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Exultai e alegrai-Vos, ó Virgem Maria, aleluia." : "Gaude et lætáre, Virgo Maria, alleluia.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: "\n℟.  ", style: TextStyle(fontSize: fs.fontSize, fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: language == "pt" ? "Porque o Senhor ressuscitou verdadeiramente, aleluia." : "Quia surréxit Dóminus vere, alleluia.", style: TextStyle(fontSize: fs.fontSize)),
                        TextSpan(text: language == "pt" ? "\n\nOremos:" : "\n\nOremus:", style: TextStyle(fontSize: fs.fontSize + 2, fontWeight: FontWeight.bold)),
                        TextSpan(
                            text: language == "pt"
