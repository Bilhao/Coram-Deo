                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: language == "pt" ? "Bendito sois, Senhor, Deus de nossos pais!" : "Benedicámus Patrem, et Filium, cum Sancto Spíritu.",
                        style: TextStyle(fontSize: fs.fontSize),
                      ),
                    ],
                  ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: language == "pt" ? "E digno de louvor e glorioso eternamente." : "Laudémus, et superexaltémus eum in sæcula.",
                        style: TextStyle(fontSize: fs.fontSize),
                      ),
                    ],
                  ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: language == "pt" ? "Bendigamos ao Pai, e o Filho, e o Espírito Santo." : "Benedíctus es, Dómine, in firmaménto cæli.",
                        style: TextStyle(fontSize: fs.fontSize),
                      ),
                    ],
                  ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: language == "pt" ? "Louvemos e por todos os séculos O exaltemos." : "Et laudábilis, et gloriósus, et superexaltátus in sæcula.",
                        style: TextStyle(fontSize: fs.fontSize),
                      ),
                    ],
                  ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: language == "pt" ? "Bendito sois, Senhor, Deus, no firmamento do céu." : "Dómine, exáudi oratiónem meam.",
                        style: TextStyle(fontSize: fs.fontSize),
                      ),
                    ],
                  ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: language == "pt" ? "Louvável, glorioso e soberanamente exaltado por todos os séculos." : "Et clamor meus ad te véniat.",
                        style: TextStyle(fontSize: fs.fontSize),
                      ),
                    ],
                  ),
                    ...
                    ? Text.rich(
                        TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: "Ouvi, Senhor, a minha oração.",
                              style: TextStyle(fontSize: fs.fontSize),
                            ),
                          ],
                        ),
                    ...
                    ? Text.rich(
                        TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: "E o meu clamor chegue até Vós.",
                              style: TextStyle(fontSize: fs.fontSize),
                            ),
                          ],
                        ),
