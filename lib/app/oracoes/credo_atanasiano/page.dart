        ...
        child: SelectionArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Text(language == "pt" ? "Quem quiser salvar-se deve antes de tudo professar a fé católica." : "Quicumque vult salvus esse, ante omnia opus est, ut teneat catholicam fidem:", style: TextStyle(fontSize: fs.fontSize)),
                Text(
