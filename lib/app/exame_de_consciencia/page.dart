      ...
      child: DefaultTabController(
        ...
        child: Builder(
          builder: (context) {
            ...
            return Scaffold(
              appBar: AppBar(
                title: const Text("Exame de Consciência", maxLines: 2, style: TextStyle(fontSize: 20)),
                actions: _selectedIndex == 0 ? [] : [IconButton(onPressed: fs.decreaseFontSize, icon: const Icon(Icons.remove)), IconButton(onPressed: fs.increaseFontSize, icon: const Icon(Icons.add))],
              ),
              ...
              body: TabBarView(children: [ItensExame(), TextoParaExame()]),
            );
          },
        ),
      ),
...
Descuidei a minha responsabilidade de aproximar de Deus os outros, com o meu exemplo e a minha palavra?""", style: TextStyle(fontSize: appProvider.fontSize)),
                  const Divider(height: 15, color: Colors.transparent),
                ],
              ),
              Text(
